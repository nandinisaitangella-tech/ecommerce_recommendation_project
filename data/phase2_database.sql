...
FROM 'C:/Users/Nandini/OneDrive/ecommerce_recommendation_project/data/e_commerce_recommendation_behaviour_and_liestyle.csv'
DELIMITER ','
CSV HEADER;
...
TRUNCATE TABLE customer_behavior_raw;

COPY customer_behavior_raw FROM 'C:/Users/Nandini/OneDrive/ecommerc
e_recommendation_project/data/e_commerce_shopper_behaviour_and_lifestyle.csv' WITH
(FORMAT text);
